...
public class LuncherMM1 {
	...
	private static final int MAX_LENGTH_WAITING_QUEUE = 100; 
	
//	private static final int VM_MIPS[] = { 500,1000,1500,2000,2500,3000
//	 };
	...
	public static void main(String[] args) {
		...
		try {
	    	...
	    	VmCloudletAssigner vmCloudletAssigner = new VmCloudletAssignermm1();
	...
	private static void printCloudletList(List<Cloudlet> list) { 
		...
		System.out.println(watingtime/finishtime/NUM_VM+"cloudlets/s");
		
		//average workload
		System.out.println(wwatingtime/finishtime/NUM_VM+"cloudlets/s");
